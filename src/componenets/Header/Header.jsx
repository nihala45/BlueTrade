...
function Header() {
  return (
    <div> <header className="sticky top-0 bg-white shadow-md flex items-center justify-between px-8 py-4 z-10">
    <h1 className="w-1/4">
      <a href="#">
        <svg viewBox="0 0 248 31" className="h-8 hover:text-green-500 duration-200">
